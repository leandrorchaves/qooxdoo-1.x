...
qx.$$loader = {
  ...
  packages : {"1":{"uris":["__out__:showcase.d83ba64568fe.js"]},"2":{"uris":["__out__:showcase.83476499f356.js"]},"4":{"uris":["__out__:showcase.05ffd61623b7.js"]},"16":{"uris":["__out__:showcase.3d85765b4834.js"]},"130":{"uris":["__out__:showcase.ef8a076af27b.js"]},"131":{"uris":["__out__:showcase.c9bb5a81f255.js"]},"256":{"uris":["__out__:showcase.53705c7fe1c3.js"]},"386":{"uris":["__out__:showcase.4a07286f234f.js"]},"512":{"uris":["__out__:showcase.17b7283b0ad1.js"]},"514":{"uris":["__out__:showcase.800855204f08.js"]},"789":{"uris":["__out__:showcase.ae88289712a8.js"]},"899":{"uris":["__out__:showcase.f5684443ffdf.js"]},"1024":{"uris":["__out__:showcase.a2eda595b8e4.js"]},"1923":{"uris":["__out__:showcase.fea8c5fc6f43.js"]},"2015":{"uris":["__out__:showcase.99e774f77ab0.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
...
this.set({name:e,part:d,icon:c,contentClass:a,description:showcase.page.DescriptionBuilder.build(e,this.__AG,this.__AW,this.__AH,this.__AI,this.__AJ,this.__AK)});
},members:{__AG:"The Html Editor, embedded here in a window with menu bar and toolbar, provides basic"+" cross-browser HTML editing capabilities and is available both as a low-level component"+" and as a qooxdoo widget. It offers events, allowing easy implementation of a toolbar "+"supplement. The UI controls of the toolbar can be used to interact "+"with the HTML editing component.",__AW:{"Text Formatting":"Format some text with underline, bold, italic, ...","Alignment":"Align the text on the right side.","Lists":"Insert a numbered or bullet point list.","Redo/Undo":"Try reverting your changes by using the undo button."},__AH:{"Inserting":"You can insert HTML tables, images, hyperlinks, ..."},__AI:{"pages/gui_toolkit/ui_html_editing.html":"Overview HTML Editing"},__AJ:{"#bom~HtmlArea.html":"Low-Level editor","#widget~HtmlArea.html":"Editor widget"},__AK:{"#qx.bom.htmlarea":"HTML Area","#qx.ui.toolbar":"Toolbar","#qx.ui.menubar":"MenuBar","#qx.ui.menu":"Menu"}}});
})();
...
},members:{__sh:null,__si:null,_createView:function(){var bt=new qx.ui.layout.Grid();
bt.setRowFlex(1,1);
...
bn.addListener(f,this.__sl,this);
bn.addListener(g,this.__sk,this);
bn.addListener(h,this.__sj,this);
bn.addListener(k,this.__sn,this);
bn.addListener(j,this.__sm,this);
...
bs.addListener(f,this.__sl,this);
bs.addListener(g,this.__sk,this);
bs.addListener(h,this.__sj,this);
bs.addListener(k,this.__sn,this);
bs.addListener(j,this.__sm,this);
...
return bu;
},__sj:function(e){var bw=e.getData(m);
...
}}},__sk:function(e){var bA=e.getTarget();
var bz=bA.getSelection().concat();
e.addData(m,bz);
},__sl:function(e){e.addType(m);
e.addAction(z);
var bB=e.getTarget().getSelection()[0];
this.__sh.set({label:bB.getLabel(),icon:bB.getIcon(),width:bB.getBounds().width});
},__sm:function(e){this.__si&&this.__si.removeState(n);
this.__sh.setDomPosition(-1000,-1000);
},__sn:function(e){var bC=e.getOriginalTarget();

if(bC instanceof qx.ui.form.ListItem){if(bC!=this.__si){this.__si&&this.__si.removeState(n);
bC.addState(n);
this.__si=bC;
}}else{this.__si&&this.__si.removeState(n);
}this.__sh.setDomPosition(e.getDocumentLeft()+15,e.getDocumentTop()+15);
}}});
})();
...
(function(){var k="complete",j="_applySelectedPage",h="__Bz",g="Boolean",f="showcase/images/welcome.png",e="showcase.Application",d="browser.name",c="stack",b="showcase/images/loading66.gif",a="selection[0]",E="selection[0].readyState",D="value",C="selection[0].description",B="showcase",A="name",z="icon",y="selectedPage",x="showcase.Page",w="state",v="__By",r="_applyShowLoadIndicator",s="en_US",p="opera",q="page-preview",n="50%",o="__md",l="selection[0].part",m="__cd",t="showLoadIndicator",u="__BA";
qx.Class.define(e,{extend:qx.application.Inline,properties:{selectedPage:{check:x,apply:j,nullable:true},showLoadIndicator:{check:g,init:false,apply:r}},members:{__cd:null,__Bx:null,__By:null,__md:null,__Bz:null,__BA:null,main:function(){qx.application.Inline.prototype.main.call(this);
...
var F=new qx.ui.root.Inline(K,false,false);
F.set({layout:L,width:900,minHeight:650,allowGrowX:false,height:null});
var G=new showcase.ui.PreviewList();
F.add(G,{row:P++,column:0,colSpan:2});
this.__cd=new qx.ui.container.Stack();
this.__cd.set({appearance:c,maxWidth:600,allowGrowX:false});
F.add(this.__cd,{row:P,column:0});
var J=new qx.ui.basic.Image(f).set({allowGrowX:true,allowGrowY:true,allowShrinkX:true,padding:[5,0,0,180]});
this.__cd.add(J);
this.__By=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
var M=new qx.ui.basic.Image(b).set({marginLeft:-33});
this.__By.add(M,{left:n,top:200});
this.__cd.add(this.__By);
this.__md=new qx.ui.container.Composite(new qx.ui.layout.Canvas());
this.__cd.add(this.__md);
this.__BA=new showcase.ui.Description();
F.add(this.__BA,{row:P++,column:1});
this.__BA.exclude();
var N=new qx.data.Array();
N.push(new showcase.page.table.Page(),new showcase.page.form.Page(),new showcase.page.virtuallist.Page(),new showcase.page.databinding.Page(),new showcase.page.tree.Page(),new showcase.page.theme.Page(),new showcase.page.i18n.Page(),new showcase.page.dragdrop.Page(),new showcase.page.htmleditor.Page());
var O=new qx.data.controller.List(N,G,A);
O.setIconPath(z);
O.bind(a,this,y);
O.bind(C,this.__BA,D);
O.bind(E,this,t,{converter:function(Q){return Q!==k;
}});
O.setDelegate({configureItem:function(R){R.set({appearance:q});
}});
...
for(var i=0;i<N.getLength();i++){if(N.getItem(i).getPart()===I){H=N.getItem(i);
break;
}}
if(H){qx.ui.core.queue.Manager.flush();
O.getSelection().push(H);
}}},_applyShowLoadIndicator:function(S){if(S){this.__cd.setSelection([this.__By]);
}else{this.__cd.setSelection([this.__md]);
}},_applySelectedPage:function(T,U){if(U){this._hidePage(U);
}this._showPage(T);
},_hidePage:function(V){if(this.getSelectedPage()!==V){if(V.getReadyState()==k){V.getContent().getView().hide();
this.__BB();
}}},_showPage:function(W){this.__BA.show();
W.load(function(X){if(this.getSelectedPage()==X){var Y=X.getContent().getView();
this.__md.add(Y,{edge:0});
if(qx.core.Environment.get(d)==p){window.setTimeout(function(){Y.show();
},100);
}else{Y.show();
}this.__BC(Y);
}},this);
},__BB:function(){if(this.__Bz){this.__Bz.cancel();
this.__Bz.dispose();
this.__Bz=null;
}},__BC:function(ba){if(qx.core.Environment.get("engine.name")=="mshtml"){return;
}ba.getContentElement().setStyle("display","none",true);
this.__BB();
qx.event.Timer.once(function(){var bb=ba.getContentElement().getDomElement();
this.__Bz=new qx.fx.effect.core.Fade(bb);
this.__Bz.set({from:0,to:1});
this.__Bz.addListenerOnce("update",function(){ba.getContentElement().setStyle("display","block");
},this);
this.__Bz.start();
},this,0);
}},destruct:function(){this._disposeObjects(m,v,o,u,h);
}});
})();
...
(function(){var n="",m="mshtml",l="engine.name",k='#',j="String",i="request",h="changeTitle",g="abstract",f="_applyState",e="browser.version",b="changeState",d="qx.bom.History",c="_applyTitle",a="qx.event.type.Data";
qx.Class.define(d,{extend:qx.core.Object,type:g,construct:function(){qx.core.Object.call(this);
this._baseUrl=window.location.href.split(k)[0]+k;
this._titles={};
this._setInitialState();
},events:{"request":a},statics:{SUPPORTS_HASH_CHANGE_EVENT:qx.core.Environment.get("event.hashchange"),getInstance:function(){if(!this.$$instance){if(!(window==window.top)&&qx.core.Environment.get(l)==m&&qx.core.Environment.get(e)>=9){this.$$instance=new qx.bom.HashHistory();
}else if(!(window==window.top)&&qx.core.Environment.get(l)==m){this.$$instance=new qx.bom.IframeHistory();
}else if(this.SUPPORTS_HASH_CHANGE_EVENT){this.$$instance=new qx.bom.NativeHistory();
}else if((qx.core.Environment.get(l)==m)){this.$$instance=new qx.bom.IframeHistory();
}else{this.$$instance=new qx.bom.NativeHistory();
}}return this.$$instance;
}},properties:{title:{check:j,event:h,nullable:true,apply:c},state:{check:j,event:b,nullable:true,apply:f}},members:{_titles:null,_applyState:function(o,p){this._writeState(o);
...
},_applyTitle:function(s){if(s!=null){document.title=s||n;
}},addToHistory:function(t,u){if(!qx.lang.Type.isString(t)){t=t+n;
}
...
this.fireDataEvent(i,v);

if(this._titles[v]!=null){this.setTitle(this._titles[v]);
}},_readState:function(){throw new Error("Abstract method call");
},_writeState:function(){throw new Error("Abstract method call");
},_setHash:function(w){var x=this._baseUrl+(w||n);
...
qx.Class.define(b,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:e,part:c,icon:d,contentClass:a,description:showcase.page.DescriptionBuilder.build(e,this.__AG,null,this.__AH,this.__AI,this.__AJ,this.__AK)});
},members:{__AG:"qooxdoo provides a powerful theming system built on a custom JSON-like "+"syntax. Unlike CSS this syntax doesn't have any cross "+"browser issues and allows styling of any widget property. It is "+"possible to create entirely different themes without touching the "+"application code."+"<p> The two calculators on this page share exactly the same application "+"and UI code and differ only in their theme.",__AH:{"States":"Widgets can have states like \"selected\" or "+"\"hovered\", which can be used by the theme to style the widgets.","Decorators":"Any HTML code can be used to style the background of a "+"widget independent of its content. Qooxdoo comes with a rich set of "+"pre-defined decorators."},__AI:{"pages/gui_toolkit/ui_theming.html":"Theming","pages/gui_toolkit/ui_appearance.html":"Appearance","pages/gui_toolkit/ui_custom_themes.html":"Custom themes","pages/gui_toolkit/ui_decorators.html":"Decorators"},__AJ:{"#ui~Decoration.html":"This demo shows all available decorators."},__AK:{"#qx.theme":"Theme Package"}}});
})();
...
qx.Class.define(g,{extend:qx.ui.root.Abstract,include:[qx.ui.core.MLayoutHandling],construct:function(s,t,u){this.__zQ=s;
s.style.overflow=f;
s.style.textAlign=b;
this.__AX=t||false;
this.__AY=u||false;
...
},members:{__AX:false,__AY:false,__zQ:null,__Ba:function(){if(this.__AX||this.__AY){var v=qx.bom.element.Dimension.getSize(this.__zQ);

if(this.__AX&&v.width<1){throw new Error("The root element "+this.__zQ+" of "+this+" needs a width when its width size should be used!");
}
if(this.__AY){if(v.height<1){throw new Error("The root element "+this.__zQ+" of "+this+" needs a height when its height size should be used!");
}if(v.height>=1&&qx.bom.element.Style.get(this.__zQ,n,3)==m){qx.bom.element.Style.set(this.__zQ,n,v.height+l);
}}qx.event.Registration.addListener(this.__zQ,r,this._onResize,this);
}},_createContainerElement:function(){var w=this.__zQ;

if(this.__AX||this.__AY){var A=document.createElement(d);
w.appendChild(A);
...
if((E.oldWidth!==E.width)&&this.__AX||(E.oldHeight!==E.height)&&this.__AY){qx.ui.core.queue.Layout.add(this);
...
}},_computeSizeHint:function(){var J=this.__AX;
var G=this.__AY;
...
if(J){var I=K.getContentWidth(this.__zQ);
F.width=I;
F.minWidth=I;
F.maxWidth=I;
}
if(G){var H=K.getContentHeight(this.__zQ);
F.height=H;
F.minHeight=H;
F.maxHeight=H;
}return F;
}},defer:function(L,M){qx.ui.core.MLayoutHandling.remap(M);
},destruct:function(){qx.event.Registration.removeListener(this.__zQ,r,this._onResize,this);
this.__zQ=null;
}});
})();
...
(function(){var i="",h="interval",g="-1000px",f="undefined",e="qx/static/blank.html",d="#",c="hidden",b="qx.bom.HashHistory",a="absolute";
qx.Class.define(b,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);
this._baseUrl=null;
this.__rI();
},members:{__rF:null,__rG:null,__rH:false,addToHistory:function(j,k){if(!qx.lang.Type.isString(j)){j=j+i;
}
if(qx.lang.Type.isString(k)){this.setTitle(k);
this._titles[j]=k;
}
if(this.getState()!==j){this.setState(j);
}},__rI:function(){this.__rG=this.__rJ();
document.body.appendChild(this.__rG);
this.__rK(function(){this._baseUrl=this.__rG.contentWindow.document.location.href;
this.__rL();
},this);
},__rJ:function(){var l=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(e)+d});
l.style.visibility=c;
l.style.position=a;
l.style.left=g;
l.style.top=g;
return l;
},__rK:function(m,n,o){if(typeof o===f){o=0;
}
if(!this.__rG.contentWindow||!this.__rG.contentWindow.document){if(o>20){throw new Error("can't initialize iframe");
}qx.event.Timer.once(function(){this.__rK(m,n,++o);
},this,10);
return;
}this.__rH=true;
m.call(n||window);
},__rL:function(){qx.event.Idle.getInstance().addListener(h,this.__rN,this);
},__rM:function(){qx.event.Idle.getInstance().removeListener(h,this.__rN,this);
},__rN:function(){var p=this._readState();

if(qx.lang.Type.isString(p)&&p!=this.getState()){this._onHistoryLoad(p);
}},_readState:function(){var q=!this._getHash()?i:this._getHash().substr(1);
return this._decode(q);
},_getHash:function(){if(!this.__rH){return;
}return this.__rG.contentWindow.document.location.hash;
},_writeState:function(r){this._setHash(this._encode(r));
},_setHash:function(s){if(!this.__rG||!this._baseUrl){return;
}var t=!this.__rG.contentWindow.document.location.hash?i:this.__rG.contentWindow.document.location.hash.substr(1);

if(s!=t){this.__rG.contentWindow.document.location.hash=s;
...
qx.Class.define(b,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:e,part:c,icon:a,contentClass:d,description:showcase.page.DescriptionBuilder.build(e,this.__AG,this.__AW,this.__AH,this.__AI,this.__AJ,this.__AK)});
},members:{__AG:"This form demo shows the complete set of form "+"widgets. The widgets are grouped by type.",__AW:{"Selection":"Open the select box to see the list of selectables.","Text":"The placeholder disappears once you start to type in a text field.","Buttons":"Hold the repeat button to see the value increase.","MenuButton":"Click the \"MenuButton\" to open the menu."},__AH:{"Widgets":"Complete set of form widgets.","Keyboard Navigation":"Try cycling through the widgets by pressing the tab key."},__AI:{"pages/gui_toolkit/ui_form_handling.html":"Form handling"},__AJ:{"#ui~FormRenderer.html":"Default form renderer","#ui~FormRendererCustom.html":"Custom form renderer","#ui~FormRendererDouble.html":"Double column form renderer","#ui~FormRendererPlaceholder.html":"Form renderer using placeholders","#ui~FormValidator.html":"Form validation","#ui~MultiPageForm.html":"Multi page form","#showcase~Form.html":"Form showcase","#data~FormController.html":"Data binding form controller","#data~Form.html":"Data bound form"},__AK:{"#qx.ui.form":"Form Package","#qx.ui.form.renderer":"Form Renderer","#qx.data.controller.Form":"Form Controller for Binding"}}});
})();
...
qx.Class.define(b,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:e,part:a,icon:c,contentClass:d,description:showcase.page.DescriptionBuilder.build(e,this.__AG,this.__AW,this.__AH,this.__AI,this.__AJ,this.__AK)});
},members:{__AG:"The table is a very powerful widget. It is “virtual” "+"in that the table data can be of any length (e.g. hundreds of thousands"+" of rows or more) yet only the rows which are actually being viewed are"+" rendered. The data you currently see is fetched from a "+"<a href='http://developer.yahoo.com/yql/' target='_blank'>YQL</a> "+"service so it's always up to date.",__AW:{"Sorting":"Click on the column header to sort the column.","Reordering":"Drag the column header to reorder.","Column Resizing":"Drag the column header separator to resize the columns.","Hide Columns":"Use the column drop-down menu in the upper right corner.","Table Resize":"Resize the window to see the table resize."},__AH:{"Cell Renderer":"Custom cell renderers like the boolean cell renderer can be configured.","Header Renderer":"Custom header renderers as shown in the “Explicit” column can be used."},__AI:{"pages/widget/table_remote_model.html":"Remote table model"},__AJ:{"#table~Table.html":"Basic table","#table~Table_Cell_Editor.html":"Cell editors","#table~Table_Conditional.html":"Conditional cell renderer","#table~Table_Context_Menu.html":"Column context menus","#table~Table_Events.html":"Table events","#table~Table_Filtered_Model.html":"Filtered Table Model","#table~Table_Huge.html":"Table with 10000 rows and 50 columns","#table~Table_Meta_Columns.html":"Table with a fixed first column","#table~Table_Resize_Columns.html":"Column auto sizing","#table~Table_Selection.html":"Table selection modes","#table~Table_Window_Editor.html":"Windowed cell editor"},__AK:{"#qx.ui.table.Table":"Table"}}});
})();
...
this.set({name:e,part:b,icon:d,contentClass:a,description:showcase.page.DescriptionBuilder.build(e,this.__AG,this.__AW,this.__AH,this.__AI,this.__AJ,this.__AK)});
},members:{__AG:"The twitter demo illustrates the use of data binding. "+"Twitter offers a REST / JSONP API, making it a perfect match for data "+"binding. The demo fetches the data and binds the result to the list. "+"Clicking on a tweet will invoke a second binding which displays the "+"selected tweet in the detail view right beside the list.",__AW:{"Detail View":"Clicking a tweet in the list shows the details.","Change Tweet":"Enter your twitter username in the text field and press \"Show\" to see your recent tweets."},__AH:{"Loading Data":"The data is loaded from twitter in real time via JSONP.","Binding":"A binding connects the model to the list view."},__AI:{"pages/data_binding/data_binding.html":"Data Binding Concepts","pages/data_binding/single_value_binding.html":"Fundamental Layer","pages/data_binding/controller.html":"Controller","pages/data_binding/stores.html":"Data Stores"},__AJ:{"#data~SingleValueBinding.html":"Single Value Binding Demo","#data~ListControllerWith3Widgets.html":"List Binding Demo","#data~TreeController.html":"Tree Binding Demo","#data~FormController.html":"Form Binding Demo","#data~Flickr.html":"Flickr Foto Search"},__AK:{"#qx.data":"Data Binding Package","#qx.data.store.Jsonp":"JSONP Data Store","#qx.data.controller.List":"List Controller","#qx.data.controller.Object":"Object Controller"}}});
})();
...
this.set({name:c,part:b,icon:e,contentClass:a,description:showcase.page.DescriptionBuilder.build(d,this.__AG,this.__AW,this.__AH,this.__AI,this.__AJ,this.__AK)});
},members:{__AG:"These two list widgets simulate a shopping system. "+"The list on the left contains all available items while the list on the "+"right displays the shopping cart. The main idea of this demo is to "+"illustrate the drag & drop feature.",__AW:{"Drag":"Try moving an item to the cart.","Reorder":"You can reorder both lists.","Move":"You can also move items back to the shop."},__AH:null,__AI:{"pages/gui_toolkit/ui_dragdrop.html":"Drag &amp; Drop"},__AJ:{"#ui~DragDrop.html":"Drag &amp; Drop with lists"},__AK:{"#qx.ui.core.Widget~drag":"Widget Drag Event","#qx.ui.core.DragDropCursor":"Drag&amp;Drop Cursor"}}});
})();
...
}},properties:{baseImage:{check:d,nullable:true,apply:f}},members:{__rT:null,__AU:null,__AV:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__rT;
...
var K=M[1];
var I=M[2];
var N=this.__AU={t:K+"-t"+I,b:K+"-b"+I,c:K+"-c"+I,l:K+"-l"+I,r:K+"-r"+I};
this.__AV={top:H.getImageHeight(N.t),bottom:H.getImageHeight(N.b),left:H.getImageWidth(N.l),right:H.getImageWidth(N.r)};
...
qx.Class.define(b,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);
this.__rL();
},members:{__rF:null,__rL:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){this.__rF=qx.lang.Function.bind(this.__rN,this);
qx.bom.Event.addNativeListener(window,d,this.__rF);
}else{qx.event.Idle.getInstance().addListener(c,this.__rN,this);
}},__rM:function(){if(qx.bom.History.SUPPORTS_HASH_CHANGE_EVENT){qx.bom.Event.removeNativeListener(window,d,this.__rF);
}else{qx.event.Idle.getInstance().removeListener(c,this.__rN,this);
}},__rN:function(){var e=this._readState();
...
(function(){var p="mshtml",o="engine.name",n="",m="interval",l="-1000px",k="request",j="qx.bom.IframeHistory",i="qx/static/blank.html",h="state",g='<html><body><div id="state">',c="browser.version",f="hidden",d="undefined",b='</div></body></html>',a="absolute";
if((qx.core.Environment.get(o)==p)){qx.Class.define(j,{extend:qx.bom.History,construct:function(){qx.bom.History.call(this);
this.__rR();
},members:{__rG:null,__rH:false,__rO:null,__rP:null,addToHistory:function(q,r){if(!qx.lang.Type.isString(q)){q=q+n;
}
if(qx.lang.Type.isString(r)){this.setTitle(r);
this._titles[q]=r;
}
if(this.getState()!==q){this.setState(q);
}},_onHistoryLoad:function(s){this._setState(s);
this.fireDataEvent(k,s);

if(this._titles[s]!=null){this.setTitle(this._titles[s]);
}},_setState:function(t){this.__rP=true;
this.setState(t);
this.__rP=false;
},_applyState:function(u,v){if(this.__rP){return;
}this._writeState(u);
},_readState:function(){if(!this.__rH){return this._decode(this._getHash());
}var w=this.__rG.contentWindow.document;
var x=w.getElementById(h);
return x?this._decode(x.innerText):n;
},_writeState:function(y){if(!this.__rH){this.__rQ();
this.__rO=qx.event.Timer.once(function(){this._writeState(y);
},this,50);
return;
}this.__rQ();
var y=this._encode(y);
if(qx.core.Environment.get(o)==p&&qx.core.Environment.get(c)!=8){this._setHash(y);
}var z=this.__rG.contentWindow.document;
z.open();
z.write(g+y+b);
z.close();
},__rQ:function(){if(this.__rO){this.__rO.stop();
this.__rO.dispose();
}},__rR:function(){this.__rI(function(){qx.event.Idle.getInstance().addListener(m,this.__rN,this);
});
},__rN:function(e){var A=null;
A=this._readState();

if(qx.lang.Type.isString(A)&&A!=this.getState()){this._onHistoryLoad(A);
}},__rS:function(B){B=this._decode(B);
this._writeState(B);
return B;
},__rI:function(C){this.__rG=this.__rJ();
document.body.appendChild(this.__rG);
this.__rK(function(){this._writeState(this.getState());

if(C){C.call(this);
}},this);
},__rJ:function(){var D=qx.bom.Iframe.create({src:qx.util.ResourceManager.getInstance().toUri(i)});
D.style.visibility=f;
D.style.position=a;
D.style.left=l;
D.style.top=l;
return D;
},__rK:function(E,F,G){if(typeof G===d){G=0;
}
if(!this.__rG.contentWindow||!this.__rG.contentWindow.document){if(G>20){throw new Error("can't initialize iframe");
}qx.event.Timer.once(function(){this.__rK(E,F,++G);
},this,10);
return;
}this.__rH=true;
E.call(F||window);
...
if(this.__rO){this.__rO.dispose();
this.__rO=null;
}qx.event.Idle.getInstance().removeListener(m,this.__rN,this);
}});
}})();
...
(function(){var q="Number",p="_applySlices",o="set",n="sliceBottom",m="horizontal",l="qx.ui.decoration.AbstractBox",k="-l",j="sliceLeft",i="_applyBaseImage",h="-b",c="sliceRight",g="_applyFill",f="shorthand",b="-t",a="-r",e="String",d="sliceTop";
qx.Class.define(l,{extend:qx.ui.decoration.Abstract,implement:[qx.ui.decoration.IDecorator],construct:function(r,s,t){qx.ui.decoration.Abstract.call(this);
this._setOrientation(t);

if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__rU=new qx.ui.decoration.css3.BorderImage();

if(r){this.__rV(r,t);
}if(s!=null){this.__rU.setInsets(s);
}}else{this.__rU=new qx.ui.decoration.BoxDiv(r,s,t);
}},properties:{baseImage:{check:e,nullable:true,apply:i},sliceLeft:{check:q,nullable:true,apply:p},sliceRight:{check:q,nullable:true,apply:p},sliceBottom:{check:q,nullable:true,apply:p},sliceTop:{check:q,nullable:true,apply:p},slices:{group:[d,c,n,j],mode:f},fill:{apply:g}},members:{__rU:null,_isHorizontal:null,_setOrientation:function(u){this._isHorizontal=u==m;
},getMarkup:function(){return this.__rU.getMarkup();
},resize:function(v,w,x){this.__rU.resize(v,w,x);
},tint:function(y,z){},getInsets:function(){return this.__rU.getInsets();
},_applyInsets:function(A,B,name){var C=o+qx.lang.String.firstUp(name);
this.__rU[C](A);
},_applySlices:function(D,E,name){var F=o+qx.lang.String.firstUp(name);
if(this.__rU[F]){this.__rU[F](D);
}},_applyFill:function(G,H,name){if(this.__rU.setFill){this.__rU.setFill(G);
}},_applyBaseImage:function(I,J){if(this.__rU instanceof qx.ui.decoration.BoxDiv){this.__rU.setBaseImage(I);
}else{this.__rV(I);
}},__rV:function(K){this.__rU.setBorderImage(K);
var Q=qx.util.AliasManager.getInstance().resolve(K);
var R=/(.*)(\.[a-z]+)$/.exec(Q);
var O=R[1];
var P=R[2];
var N=qx.util.ResourceManager.getInstance();

if(this._isHorizontal){var T=N.getImageWidth(O+k+P);
var L=N.getImageWidth(O+a+P);

if(L&&T){this.__rU.setSlice([0,L,0,T]);
}}else{var M=N.getImageHeight(O+h+P);
var S=N.getImageHeight(O+b+P);

if(S&&M){this.__rU.setSlice([S,0,M,0]);
}}}},destruct:function(){this.__rT=this.__AU=this.__AV=null;
this.__rU.dispose();
}});
})();
...
this.set({name:c,part:a,icon:d,contentClass:b,description:showcase.page.DescriptionBuilder.build(f,this.__AG,this.__AW,this.__AH,this.__AI,this.__AJ,this.__AK)});
},members:{__AG:'Internationalization (or \"I18N\" for short) is all about making'+" a system support different natural languages and"+" locales in its user interface. qooxdoo has full translation support "+"and comprises locale information of virtually every country in the world.",__AW:{"Change the language":"Hit one of the flag buttons on the top to change "+"the language. All labels on the page will be translated, including "+"labels in standard qooxdoo widgets like the calendar.","Change the country":"The first select box on the left lets you change the country code. "+"The country code defines things like date or number formats. Try "+"changing the country code from <em>United States</em> to "+"<em>Great Britain</em>. You will see that e.g. the start of the week "+"changes from Sunday to Monday.","Open the command menu":"The command menu button in the lower left opens a popup menu. Even the "+"keyboard shortcuts are localized."},__AH:{"Standards based translation":"Translation data is extracted into standard <em>.po</em> "+"files, as defined by GNU <em>gettext</em> tools. Many "+"open source tools can process those translation files.","CLDR":"Localisation data like date and time formats are taken from the "+"<a href='http://cldr.unicode.org/'>Unicode Common Locale Data Repository</a> (CLDR). This "+"guarantees that qooxdoo uses the standardized data for even the smallest "+"countries.","Live locale switching":"All widgets are designed in a way that allows for locale switching in the running application."},__AI:{"pages/development/internationalization.html":"Internationalization"},__AJ:{"#showcase~Localization.html":"Localization demo"},__AK:{"#qx.locale":"Locale Package"}}});
})();
...
(function(){var e="Virtual List",d="showcase.page.virtuallist.Page",c="showcase/virtuallist/icon.png",b="virtuallist",a="showcase.page.virtuallist.Content";
qx.Class.define(d,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:e,part:b,icon:c,contentClass:a,description:showcase.page.DescriptionBuilder.build(e,this.__AG,this.__AW,this.__AH,this.__AI,this.__AJ,this.__AK)});
},members:{__AG:"Using the virtual infrastructure has considerable"+" advantages when there is a huge amount of model items to render"+" because the virtual infrastructure only creates widgets for visible"+" items and reuses them. This saves both creation time and memory.",__AW:{"Close Group":"Click on the arrow of a group item to close the group.","Change User Data":"Select a user and change values for e.g. status.","Add User":"Press the add user button and enter name and group.","Delete User":"Select a user and press the delete button."},__AH:{"Filtering":"You can use a filter to hide model items.","Sorting":"You can sort the list with a custom algorithm.","Grouping":"You can define a group for each mode item.","Selection":"You can use different selection modes (single selection,"+" multi selection).","Data Binding":"You can bind model values with the rendered widget.","Custom Rendering":"You can configure the used widgets or create your own."},__AI:{"pages/widget/virtuallist.html":"Virtual List"},__AJ:{"#virtual~List.html":"List overview","#virtual~ListWithFilter.html":"Filtering example","#virtual~ExtendedList.html":"Custom rendering example","#virtual~GroupedList.html":"Grouping example"},__AK:{"#qx.ui.list.List":"Virtual List","#qx.ui.list.core.IListDelegate":"List delegate"}}});
})();
...
qx.Class.define(d,{extend:showcase.Page,construct:function(){showcase.Page.call(this);
this.set({name:e,part:b,icon:a,contentClass:c,description:showcase.page.DescriptionBuilder.build(e,this.__AG,this.__AW,this.__AH,this.__AI,this.__AJ,this.__AK)});
},members:{__AG:"The two tree views display some hierarchical data "+"including folders, icons and labels. The tree in the right window has "+"some additional infomation attached to each item.",__AW:{"Expand":"Try expanding some folders by using the arrow icon or double clicking.","Resize":"Resize the window to make the tree scrollbars appear.","Selection":"Select multiple items, e.g. by holding the Shift key."},__AH:{"Configurable":"Each tree item has a configurable label and icon.","Scrolling":"Tree displays scrollbars if necessary.","Multi Columns":"Tree folders can display additional information in separate columns."},__AI:{"pages/widget/tree.html":"The Tree Widget"},__AJ:{"#widget~Tree.html":"Configurable Tree","#widget~Tree_Columns.html":"Multi Column Tree","#data~TreeController.html":"Tree using Data Binding","#data~JsonToTree.html":"Tree filled with Data from a JSON file.","#data~ExtendedTree.html":"Tree using Data Binding with configuration"},__AK:{"#qx.ui.tree":"Tree Package"}}});
})();
...
if(D){I.push(y,this.__Be(D));
}
if(E){I.push(c,this.__Be(E));
}
if(F){I.push(w,this.__Bd(this._manualPrefix,F));
}
if(G){I.push(t,this.__Bd(this._demoPrefix,G));
}
if(H){I.push(x,this.__Bd(this._apiPrefix,H));
}I.push(d);
return I.join(i);
},__Bd:function(J,K){var L=[g];

for(var M in K){L.push(b,J,M,p,K[M],z);
}L.push(f);
return L.join(i);
},__Be:function(N){var O=[g];
